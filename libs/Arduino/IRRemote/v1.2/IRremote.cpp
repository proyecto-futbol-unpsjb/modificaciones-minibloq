...
// AGREGADO PROYECTO SADOSKY 2018 UNPSJB MADRYN
...
#if 0
// Multiplo: Send not supported yet
...
IRrecv::IRrecv(int recvpin) : enabled (false) //##miniBloq
{
...
{
	//Restores timer 2 (the timer used by Multiplo DuinoBot.v2.x):
	TCCR2A = _tccr2a;
	TCCR2B = _tccr2b;
	TIMSK2 = _timsk2;
	OCR2A = _ocr2a;
    ...
    if (decode(&results))
    {
        ...
        if (results.decode_type == RC5)  //By now, only supports RC5 Format.
        {
            ...
            if ( (strcmp(command, "0") == 0) || (strcmp(command, "800") == 0)) //##Ver si el cero es correcto.
                ...
                result = 9;
            else if ((strcmp(command, "80c")  == 0) || (strcmp(command, "c") == 0)) {
                //Remote control's POWER button: By now do nothing.
                return BOTON_POWER;
            }
            else if ((strcmp(command, "80d")  == 0) || (strcmp(command, "d") == 0)) {
                return BOTON_MUTE;
            }
            else if ((strcmp(command, "80f")  == 0) || (strcmp(command, "f") == 0)) {
                return BOTON_OSD;
            }
            else if ((strcmp(command, "810")  == 0) || (strcmp(command, "10") == 0)) {
                return BOTON_DERECHA;
            }
            else if ((strcmp(command, "811")  == 0) || (strcmp(command, "11") == 0)) {
                return BOTON_IZQUIERDA;
            }
            else if ((strcmp(command, "820")  == 0) || (strcmp(command, "20") == 0)) {
                return BOTON_ARRIBA;
            }
            else if ((strcmp(command, "821")  == 0) || (strcmp(command, "21") == 0)) {
                return BOTON_ABAJO;
            }
            else if ((strcmp(command, "822")  == 0) || (strcmp(command, "22") == 0)) {
                return BOTON_ACH;
            }
            else if ((strcmp(command, "83c")  == 0) || (strcmp(command, "3c") == 0)) {
                return BOTON_3RAYAS;
            }
            else if ((strcmp(command, "823")  == 0) || (strcmp(command, "23") == 0)) {
                return BOTON_III;
            }
            else if ((strcmp(command, "82a")  == 0) || (strcmp(command, "2a") == 0)) {
                return BOTON_TIMER;
            }
            else if ((strcmp(command, "820")  == 0) || (strcmp(command, "20") == 0)) {
                return BOTON_3RAYAS;
            }
            else if ((strcmp(command, "82b")  == 0) || (strcmp(command, "2b") == 0)) {
                return BOTON_PANTALLA1;
            }
            else if ((strcmp(command, "829")  == 0) || (strcmp(command, "29") == 0)) {
                return BOTON_PANTALLA2;
            }
            else if ((strcmp(command, "838")  == 0) || (strcmp(command, "38") == 0)) {
                return BOTON_AV;
            }
        }
